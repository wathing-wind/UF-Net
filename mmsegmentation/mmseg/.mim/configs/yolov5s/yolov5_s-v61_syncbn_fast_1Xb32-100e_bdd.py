...
data_root = '/data1/xt_dataset_2/mtl_ad/BDD100K/bdd100k'  # 数据集目录的绝对路径
...
load_from = '/data1/xt_dataset_2/mtl_ad/BDD100K/bdd100k/epoch_98.pth'  # noqa
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        dataset=dict(
            ...
            data_root=data_root,
            metainfo=metainfo,
            ann_file='/data1/xt_dataset_2/mtl_ad/BDD100K/COCO/det_train_coco.json',
            data_prefix=dict(img='/data1/xt_dataset_2/mtl_ad/BDD100K/bdd100k/images/train/'),
...
val_dataloader = dict(
    dataset=dict(
        metainfo=metainfo,
        data_root=data_root,
        ann_file='/data1/xt_dataset_2/mtl_ad/BDD100K/COCO/det_val_coco.json',
        data_prefix=dict(img='/data1/xt_dataset_2/mtl_ad/BDD100K/bdd100k/images/100k/val/')))

test_dataloader = val_dataloader

val_evaluator = dict(ann_file='/data1/xt_dataset_2/mtl_ad/BDD100K/COCO/det_val_coco.json')
