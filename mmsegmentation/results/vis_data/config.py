...
default_hooks = dict(
    ...
    visualization=dict(draw=True, interval=1, type='VisualizationHook'))
default_scope = 'mmseg'
    ...
    dataset=dict(
        ...
        pipeline=[
            ...
            dict(
                ...
                type='LetterResize'),
            dict(
                _scope_='mmdet', type='mmyolo.LoadAnnotations',
                with_bbox=True),
            dict(
                meta_keys=(
                    'img_id',
...
test_pipeline = [
    ...
    dict(
        ...
        type='LetterResize'),
    dict(_scope_='mmdet', type='mmyolo.LoadAnnotations', with_bbox=True),
    dict(
        meta_keys=(
            'img_id',
            'img_path',
...
train_cfg = dict(
    max_iters=120000, type='IterBasedTrainLoop', val_interval=200000)
